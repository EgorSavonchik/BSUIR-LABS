...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        checkButton->setGeometry(QRect(100, 390, 93, 29));
        plainTextEdit = new QPlainTextEdit(centralwidget);
        plainTextEdit->setObjectName(QString::fromUtf8("plainTextEdit"));
        plainTextEdit->setGeometry(QRect(130, 70, 361, 221));
        fileButton = new QPushButton(centralwidget);
        fileButton->setObjectName(QString::fromUtf8("fileButton"));
        fileButton->setGeometry(QRect(570, 390, 93, 29));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        fileButton->setText(QCoreApplication::translate("MainWindow", "check file", nullptr));
    } // retranslateUi
